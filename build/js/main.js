...
(function () {
  ...
  telInput.addEventListener("focus", function () {
    var telMask = window.mask.imask(telInput, maskOptions);
    telMask.cursorPos = 3;
    telInput.value = "+7(";
  });
  ...
  callbackButton.addEventListener("click", function () {
    ...
    callbackTelInput.addEventListener("focus", function () {
      var callbackTelMask = window.mask.imask(callbackTelInput, maskOptions);
  ...
  var CLOSE_SITE_MAP = "\u0417\u0430\u043A\u0440\u044B\u0442\u044C \u0440\u0430\u0437\u0434\u0435\u043B\u044B \u0441\u0430\u0439\u0442\u0430";
